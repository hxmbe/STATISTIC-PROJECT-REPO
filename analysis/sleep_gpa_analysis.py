...
print("""
  ...
  ✓ Normal/CLT:   n = 99 ≥ 30 → Central Limit Theorem guarantees approximate
                  normality of the sampling distribution of x̄.
  ✓ Independence: Responses from different students.
                  n = 99 < 10% of school population (~3,000+). ✓

  For one-sample z-test (proportion sleeping ≥ 8h vs p₀ = 0.25):
  ✓ Random:       See above.
  ✓ Large Counts: np₀ = 99 × 0.25 = 24.75 ≥ 10 ✓
                  n(1−p₀) = 99 × 0.75 = 74.25 ≥ 10 ✓
  ...
  ✓ Normal:       n = 99 ≥ 30; CLT supports approximate normality. ✓
...
# =============================================================================
# SECTION 8 — GRADE-LEVEL SUMMARY  (Unit 1: Exploratory)
# =============================================================================

print("\n" + "=" * 65)
print("SECTION 8 — GRADE-LEVEL SUMMARY  (Unit 1: Exploratory)")
print("=" * 65)
print()
...
# =============================================================================
# SECTION 9 — BIASES & LIMITATIONS
# =============================================================================

print("\n" + "=" * 65)
print("SECTION 9 — BIASES & LIMITATIONS")
print("=" * 65)
print("""
  Sampling:
...
# =============================================================================
# SECTION 10 — EXPORT SUMMARY TABLE
# =============================================================================

print("=" * 65)
print("SECTION 10 — EXPORT SUMMARY TABLE")
print("=" * 65)
